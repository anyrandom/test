...
conversation = [
    ...
    {"role": "system",
     "content": "You are a Keurig AI assistant built to help people find coffee or tea or dessert recipes from the brand "
...
if wav_audio_data is not None:
    prompt = handle_voice_input(wav_audio_data)
else:
